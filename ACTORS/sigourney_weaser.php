...
<head>
	...
	<title>Sigourney Weaser</title>
</head>
<body>
	<h1>Sigourney Weaser</h1>
	<?php 
		...
		if($db)
		{
            ...
            WHERE actors.name = "sigourney weaser"
			...
			{
				echo '<div><a href="../MOVIES/'.str_replace(' ', '_', $db_field_movies['title']).'.php">'.ucwords($db_field_movies['title']).'</a></div><br>';
			}
