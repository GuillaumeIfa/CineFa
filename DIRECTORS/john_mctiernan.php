...
<head>
	...
	<title>John Mctiernan</title>
</head>
<body>
	<h1>John Mctiernan</h1>
	<?php 
		...
		if($db)
		{
			...
			WHERE directors.name = "john mctiernan"
			...
			{
				echo '<div><a href="../MOVIES/'.str_replace(' ', '_', $db_field_movies['title']).'">'.ucwords($db_field_movies['title']).'</a></div><br>';
			}
